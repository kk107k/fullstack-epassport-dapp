// JavaScript component to generate select options
class CountrySelect {
    constructor(elementId) {
      ...
      this.countries = [
        ...
        "Cocos (Keeling) Islands", "Colombia", "Comoros", "Congo", "Congo, Democratic Republic of the Congo", "Cook Islands",
        ...
        "Serbia", "Serbia and Montenegro", "Seychelles", "Sierra Leone", "Singapore", "Sint Maarten", "Slovakia",
    ...
    // Method to generate select options
    generateOptions() {
